...
namespace LibraryHub.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,CategoryId,AuthorId,IsAvailable")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CategoryId,AuthorId,IsAvailable")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
